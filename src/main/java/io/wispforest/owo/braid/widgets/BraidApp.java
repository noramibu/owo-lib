...
public class BraidApp extends StatelessWidget {
    ...
    private static final KeyModifiers SHIFT = new KeyModifiers(MOD_SHIFT);
    private static final KeyModifiers CTRL = new KeyModifiers(MOD_CONTROL);
    ...
    public static final Map<List<ShortcutTrigger>, Intent> DEFAULT_SHORTCUTS = Map.of(
        List.of(new ShortcutTrigger(
            Trigger.ofKey(KEY_RETURN),
            Trigger.ofKey(KEY_NUMPADENTER),
            Trigger.ofKey(KEY_SPACE)
        )), PrimaryActionIntent.INSTANCE,
        List.of(new ShortcutTrigger(
            Trigger.ofKey(KEY_RETURN, SHIFT),
            Trigger.ofKey(KEY_NUMPADENTER, SHIFT),
            Trigger.ofKey(KEY_SPACE, SHIFT)
        ...
        List.of(new ShortcutTrigger(Trigger.ofKey(KEY_TAB))), new TraverseFocusIntent(FocusTraversalDirection.NEXT),
        List.of(new ShortcutTrigger(Trigger.ofKey(KEY_TAB, SHIFT))), new TraverseFocusIntent(FocusTraversalDirection.PREVIOUS)
    );
    ...
    public static final Map<List<ShortcutTrigger>, Intent> DEFAULT_TEXT_SHORTCUTS = Util.make(() -> {
        ...
        builder.put(List.of(new ShortcutTrigger(Trigger.ofKey(KEY_TAB))), InsertTabIntent.INSTANCE);
        builder.put(List.of(new ShortcutTrigger(Trigger.ofKey(KEY_BACKSPACE))), new DeleteTextIntent(false, false));
        builder.put(List.of(new ShortcutTrigger(Trigger.ofKey(KEY_BACKSPACE)).withModifiers(CTRL)), new DeleteTextIntent(false, true));
        builder.put(List.of(new ShortcutTrigger(Trigger.ofKey(KEY_DELETE))), new DeleteTextIntent(true, false));
        builder.put(List.of(new ShortcutTrigger(Trigger.ofKey(KEY_DELETE)).withModifiers(CTRL)), new DeleteTextIntent(true, true));
        builder.put(List.of(new ShortcutTrigger(Trigger.ofKey(KEY_DELETE)).withModifiers(SHIFT)), DeleteLineIntent.INSTANCE);
        ...
        builder.put(List.of(new ShortcutTrigger(Trigger.ofKey(KEY_A)).withModifiers(CTRL)), SelectAllIntent.INSTANCE);
        builder.put(List.of(new ShortcutTrigger(Trigger.ofKey(KEY_C)).withModifiers(CTRL)), new CopyTextIntent(false));
        builder.put(List.of(new ShortcutTrigger(Trigger.ofKey(KEY_X)).withModifiers(CTRL)), new CopyTextIntent(true));
        builder.put(List.of(new ShortcutTrigger(Trigger.ofKey(KEY_V)).withModifiers(CTRL)), PasteTextIntent.INSTANCE);
